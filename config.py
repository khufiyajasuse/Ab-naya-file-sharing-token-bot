...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002148936460"))
...
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://dusra:sLwO6AhOgadMNHL5@dusra.r7gkttx.mongodb.net/?retryWrites=true&w=majority&appName=dusra")
...
TUT_VID = os.environ.get("TUT_VID", "https://t.me/sumaira_khan_howtoopenlink/33") # shareus ka tut_vid he 

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002208326155"))
